...
export const industriesType = [
  ...
  export const MenuItems = [
    ...
    {id:24,role_type:'supplier',label:'PO List',iconLabel:<SolutionOutlined />, component: <SupplierPOList />},
    ...
    // {id:7,role_type:'consumer',label:'Home(Dashboard)',iconLabel:<SolutionOutlined />, component: <RfqList />},
    ...
    {id:16,role_type:'supplier',label:'Factory Profile',iconLabel:<SolutionOutlined />, component: <SupplierAccount />},
  ]
