...
import { userLogin, userforgotPassword,userLogout } from "../redux/actions/authAction";
...
const ForgotPasswordPage = () => {
  ...
  const forgetUser = async (e) => {
    ...
    try {
      setAppLoading(true)
      dispatch(userforgotPassword(userCreds,UserRole.SUPPLIER))
      setTimeout(() => {   
        setAppLoading(false)
      }, 1000);
    } catch (err) {
          ...
          <Card>
            ...
            <form>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px'}}>
                ...
                {/* <ForgotPassword href="/">Login?</ForgotPassword> */}
              </div>
              <Button
                type="submit"
                onClick={forgetUser}>
            ...
            <p style={{ textAlign: 'center', color: '#6b7280', marginTop: '1rem' }} onClick={() => navigate(-1)}>
              <SignUpLink>Back</SignUpLink>
            </p>
          </Card>
        )}
      </RightSection>
