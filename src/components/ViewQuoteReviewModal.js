...
const ViewQuoteReviewModal = ({ currentRfqData, open, setOpen, viewLoading, showLoading, productList, isEdit }) => {
        ...
        <div style={{ padding: "10px 20px" }}>
          <Typography>
            ...
            {currentRfqData?.tax_category && <Paragraph style={{ marginBottom: 8 }}>
              <Text strong>Tax:</Text> {currentRfqData?.tax_category} AED
            </Paragraph>}
            {currentRfqData?.total_amount_review &&
            <Paragraph style={{ marginBottom: 8 }}>
              <Text strong>Total / Final Price:</Text> {currentRfqData?.total_amount_review} AED
            </Paragraph>}
          </Typography>
        </div>
    </Modal>
...
export default ViewQuoteReviewModal;
